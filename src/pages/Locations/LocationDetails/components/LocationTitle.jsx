        ...
        <div style={{display:'flex' , flexDirection:'row'}}>
            <div>
                <h1 style={{marginTop: 25, marginBottom: 5}} className="location-title text-2xl font font-extrabold tracking-tight text-gray-900">
                    {randomNumber % 2 === 0 ?
                        <Gradient dir="left-to-right" from={textGradients[randomNumber]} to={textGradients[randomNumber+1]}>
                            {props.title}
                        </Gradient>
                        :
                        <Gradient dir="left-to-right" from={textGradients[randomNumber]} to={textGradients[randomNumber-1]}>
                ...
                <span>
                  {randomNumber % 2 === 0 ?
                      <Gradient dir="right-to-left" from={textGradients[randomNumber]} to={textGradients[randomNumber+1]}>
                          {props.description}
                      </Gradient>
                      :
                      <Gradient dir="right-to-left" from={textGradients[randomNumber]} to={textGradients[randomNumber-1]}>
